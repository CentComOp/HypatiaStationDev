...
/mob/living/carbon/alien/larva/verb/evolve()
	...
	if(amount_grown >= max_grown)	//TODO ~Carn
		...
		src << "<B>Hunters</B> \blue are strong and agile, able to hunt away from the hive and rapidly move through ventilation shafts. Hunters generate phoron slowly and have low reserves."
		...
		src << "<B>Drones</B> \blue are the working class, offering the largest phoron storage and generation. They are the only caste which may evolve again, turning into the dreaded alien queen."
