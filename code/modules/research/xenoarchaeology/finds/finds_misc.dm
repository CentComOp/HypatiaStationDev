...
/obj/item/weapon/shard/phoron/attackby(obj/item/weapon/W as obj, mob/user as mob, params)
	..()
	if ( istype(W, /obj/item/weapon/weldingtool))
		var/obj/item/weapon/weldingtool/WT = W
		if(WT.remove_fuel(0, user))
			var/obj/item/stack/sheet/phoronglass/NG = new (user.loc)
			for (var/obj/item/stack/sheet/phoronglass/G in user.loc)
				if(G==NG)
					continue
