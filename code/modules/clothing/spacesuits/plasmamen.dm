...
/obj/item/clothing/suit/space/eva/phoronman
	name = "phoronman suit"
	...
	flags = STOPSPRESSUREDMAGE  | PHORONGUARD
...
/obj/item/clothing/suit/space/eva/phoronman/examine(mob/user)
	..()
	user << "<span class='info'>There are [extinguishes_left] extinguisher canisters left in this suit.</span>"

/obj/item/clothing/suit/space/eva/phoronman/proc/Extinguish(var/mob/user)
...
/obj/item/clothing/head/helmet/space/eva/phoronman
...
/obj/item/clothing/head/helmet/space/eva/phoronman/attack_self(mob/user)
	if(!isturf(user.loc))
...
/obj/item/clothing/head/helmet/space/eva/phoronman/pickup(mob/user)
	if(on)
		user.set_light(user.luminosity + brightness_on)
//		user.UpdateLuminosity()
		set_light(0)

/obj/item/clothing/head/helmet/space/eva/phoronman/dropped(mob/user)
	if(on)
		user.set_light(user.luminosity - brightness_on)
//		user.UpdateLuminosity()
...
/obj/item/clothing/suit/space/eva/phoronman/cargo
	name = "phoronman cargo suit"
	icon_state = "phoronmanCargo_suit"

/obj/item/clothing/head/helmet/space/eva/phoronman/cargo
	name = "phoronman cargo helmet"
	icon_state = "phoronmanCargo_helmet0"
	base_state = "phoronmanCargo_helmet"

/obj/item/clothing/suit/space/eva/phoronman/miner
...
/obj/item/clothing/head/helmet/space/eva/phoronman/miner
...
/obj/item/clothing/suit/space/eva/phoronman/nuclear
...
/obj/item/clothing/head/helmet/space/eva/phoronman/nuclear
...
/obj/item/clothing/head/helmet/space/eva/phoronman/nuclear/attack_self(mob/user)
	if(camera)
		..(user)
	else
...
/obj/item/clothing/head/helmet/space/eva/phoronman/nuclear/examine(mob/user)
	..()
