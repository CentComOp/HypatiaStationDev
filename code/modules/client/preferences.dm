...
/datum/preferences
	proc/ShowChoices(mob/user)
		...
		//		dat += "Skin pattern: <a href='byond://?src=\ref[user];preference=skin_style;task=input'>Adjust</a><br>"
				...
				if(species == "Soghun" || species == "Tajaran" || species == "Skrell" || species == "Slime People" || species == "Vulsarian")
		...
		switch(href_list["task"])
			if("random")
				switch(href_list["preference"])
					...
					if("hair")
						if(species == "Human" || species == "Soghun" || species == "Tajaran" || species == "Skrell" || species == "Machine" || species == "Wryn" || species == "Vulsarian")
							r_hair = rand(0,255)
							g_hair = rand(0,255)
							b_hair = rand(0,255)
					if("h_style")
					...
					if("s_color")
						if(species == "Soghun" || species == "Tajaran" || species == "Skrell" || species == "Slime People" || species == "Wryn" || species == "Vulsarian")
							r_skin = rand(0,255)
							g_skin = rand(0,255)
							b_skin = rand(0,255)
					if("bag")
			...
			if("input")
				switch(href_list["preference"])
					...
					if("species")
						...
						var/list/new_species = list("Human","Tajaran","Skrell","Soghun","Diona", "Vulsarian")
...
*/
					...
					if("hair")
						if(species == "Human" || species == "Soghun" || species == "Tajaran" || species == "Skrell" || species == "Machine" || species == "Vulsarian")
